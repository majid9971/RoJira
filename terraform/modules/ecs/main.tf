# =============================================================
# ECS Module – Cluster, Task Definition, Service, ALB
# =============================================================
...
resource "aws_ecs_cluster" "main" {
  ...
  tags = merge(var.tags, { Name = "${var.app_name}-${var.environment}-cluster" })
}
...
# Task Role (application permissions at runtime)
